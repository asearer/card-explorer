  ...
  return (
    <div className="page-container">
      <div className="content">
        ...
        <p>Feel free to browse through the demo cards provided in the app, and please don't hesitate to provide any suggestions or feedback that you might have using the subject 'Ethiria'!</p>
      </div>
    </div>
  );
};
